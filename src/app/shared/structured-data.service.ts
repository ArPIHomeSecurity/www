...
export class StructuredDataService {
  ...
  createOrganizationStructuredData() {
    const structuredData = {
      ...
      description:
        'ArPI is an open-source Raspberry Pi based home security system that allows you to replace ' +
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text:
              'You can download the source code from GitHub, follow our documentation, or purchase a ' +
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text:
              'Yes, ArPI is completely open-source and free to use. You only need to purchase the hardware ' +
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text:
              'You can get support through our GitHub repository, Slack community, or contact us directly ' +
              'through our website.',
          },
        },
      ],
  ...
  createTechArticleStructuredData() {
    const structuredData = {
      ...
      description:
        'Complete guide to ArPI home security system: features, installation, and usage of this ' +
  ...
  createHowToStructuredData() {
    const structuredData = {
      ...
      description:
        'Step-by-step guide to install and configure ArPI home security system on Raspberry Pi',
      image: {
        '@type': 'ImageObject',
